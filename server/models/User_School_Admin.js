...
async function createStudent(data) {
  const {
    student_id, student_name, class: className, section, father_name, mother_name, dob,
  ...
  const [result] = await db.execute(
    `INSERT INTO student (
      ...
      gender, contact_no, admission_year, prev_school_name, address,
      school_id, national_id, email, stud_pic_url, created_at, updated_at
    ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), NOW())`,
    [
      student_id, student_name, className, section, father_name, mother_name, dob,
      gender, contact_no, admission_year, prev_school_name, address,
      school_id, national_id, email, stud_pic_url
    ]
  );
...
async function updateStudent(id, data) {
  ...
  const [result] = await db.execute(
    `UPDATE student SET
      student_id=?, student_name=?, class=?, section=?, father_name=?, mother_name=?, dob=?,
      gender=?, contact_no=?, admission_year=?, prev_school_name=?, address=?,
      school_id=?, national_id=?, email=?, stud_pic_url=?, updated_at=NOW()
    WHERE id=?`,
    [
      student_id, student_name, className, section, father_name, mother_name, dob,
      gender, contact_no, admission_year, prev_school_name, address,
      school_id, national_id, email, stud_pic_url, id
    ]
  );
