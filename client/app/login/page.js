...
import { Eye, EyeOff, User, Mail, Lock, GraduationCap, ArrowRight, ArrowLeft, School, MapPin, Phone } from 'lucide-react';
    ...
    <div className="relative mb-3 sm:mb-4">
      <div className="relative">
        ...
        <input
          ...
          value={value}
          onChange={onChange}
          className={`w-full pl-10 sm:pl-12 pr-10 sm:pr-12 py-2.5 sm:py-3 border-2 rounded-lg focus:outline-none focus:border-blue-500 transition-colors text-sm sm:text-base ${
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 flex items-center justify-center p-2 sm:p-4">
      <div className="bg-white rounded-2xl shadow-2xl overflow-hidden w-full max-w-6xl min-h-[500px] sm:min-h-[600px] flex flex-col lg:flex-row">
        ...
        <div className={`w-full lg:w-1/2 bg-gradient-to-br from-blue-500 to-purple-600 p-6 sm:p-8 lg:p-12 flex flex-col justify-center items-center text-white relative overflow-hidden transition-all duration-700 ${
            ...
            >
              {isLogin ? (
                ...
                <>
                  ...
                  <span className='text-black'>Already have account? Sign In</span>
                </>
              )}
            </button>
          </div>
